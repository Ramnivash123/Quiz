            ...
            <?php
                ...
                if (count($result) > 0) {
                    ...
                    foreach ($result as $row) {
                        ...
                        echo "<tr>
                                <td><button class='assignment-button' onclick='viewAssignment(\"" . htmlspecialchars($row["title"]) . "\")'>" . htmlspecialchars($row["title"]) . "</button></td>
                                <td>" . htmlspecialchars($row["timer"]) . " mins</td>
                                <td>" . htmlspecialchars($assignedOn) . "</td>
                                <td>
                                    <button class='assignment-button delete-button' onclick='deleteAssignment(\"" . htmlspecialchars($row["id"]) . "\")'>Delete</button>
                                </td>
                            </tr>";
                    }
                } else {
